...
export async function generateMetadata(): Promise<Metadata> {
    ...
    if (!policy) {
        return {
            title: 'سياسة الإرجاع - أمواج للمياه الصحية',
            description: 'سياسة الإرجاع والاستبدال للمنتجات',
        };
    }
    ...
    return {
        ...
        keywords: 'سياسة الإرجاع, استبدال المنتجات, أمواج للمياه الصحية',
    };
}
                ...
                <Card>
                    <CardHeader>
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                <CardTitle className="text-2xl">سياسة الإرجاع</CardTitle>
                    ...
                    <CardContent>
                        <div className="text-center py-8 space-y-4">
                            ...
                            <h3 className="text-lg font-semibold">سياسة الإرجاع غير متوفرة حالياً</h3>
                            <p className="text-muted-foreground">
                                لم يتم نشر سياسة الإرجاع بعد. يرجى المحاولة لاحقاً أو التواصل معنا للاستفسار.
                            </p>
            ...
            <Card>
                <CardContent className="pt-6">
                    <div className="text-center text-sm text-muted-foreground space-y-2">
                        ...
                        <p>
                            للاستفسارات حول سياسة الإرجاع، يرجى التواصل معنا عبر:
                        </p>
