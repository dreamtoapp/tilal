...
export async function generateMetadata(): Promise<Metadata> {
    ...
    if (!policy) {
        return {
            title: 'سياسة الخصوصية - أمواج للمياه الصحية',
    ...
    return {
        ...
        keywords: 'سياسة الخصوصية, حماية البيانات, أمواج للمياه الصحية',
    };
}
                ...
                <Card>
                    ...
                    <CardContent>
                        <div className="text-center py-8 space-y-4">
                            ...
                            <h3 className="text-lg font-semibold">سياسة الخصوصية غير متوفرة حالياً</h3>
                            <p className="text-muted-foreground">
                                لم يتم نشر سياسة الخصوصية بعد. يرجى المحاولة لاحقاً أو التواصل معنا للاستفسار.
                            </p>
